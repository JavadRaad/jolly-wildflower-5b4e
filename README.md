...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/jolly-wildflower-5b4e)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/jolly-wildflower-5b4e
```

A live public deployment of this template is available at [https://jolly-wildflower-5b4e.templates.workers.dev](https://jolly-wildflower-5b4e.templates.workers.dev)
